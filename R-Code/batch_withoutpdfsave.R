...
dataThreat100 <- dataY[ExThreat==100]
...
lines(d$tick, d$sd02, col ="black", lwd ="2")
lines(d$tick, d$sd04, col ="blue", lwd ="2")
lines(d$tick, d$sd06, col ="green", lwd ="2")
lines(d$tick, d$sd08, col ="orange", lwd ="2")
lines(d$tick, d$sd1, col ="red", lwd ="2")
